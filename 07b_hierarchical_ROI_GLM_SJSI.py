...
# ### must define: dataset name, model number and TR
...
if is_interactive():
    ...
    import subprocess
    import itertools
    os.system('jupyter nbconvert --to script 07b_hierarchical_ROI_GLM_SJSI.ipynb')  # make script from this notebook
    ...
    def call_shell(roi, model_n, t_r):
        subprocess.run(["ipython", "07b_hierarchical_ROI_GLM_SJSI.py", roi, str(model_n), str(t_r)]) 
